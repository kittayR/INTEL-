...
class Reviews:
    def __init__(self, asin) -> None:
        ...
        self.url = f'https://www.amazon.in/Intel-i7-13700K-Desktop-Processor-P-cores/product-reviews/{self.asin}/ref=cm_cr_arp_d_viewopt_sr?ie=UTF8&reviewerType=all_reviews&filterByStar=four_star&pageNumber='
